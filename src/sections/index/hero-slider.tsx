...
const HeroSlider = () => {
  ...
  return (
    <div className="h-[100vh] w-full block relative">
     {!isVideoPlaying && <video autoPlay loop muted className="w-full h-full object-cover">
        <source src="./videos/hero-video.mp4" type="video/mp4" />
      </video>}
      {isVideoPlaying  && <video autoPlay className="w-full h-full object-cover">
      ...
      <div
        ...
        className="bs-cursor-container z-20 absolute w-full h-[calc(100vh_-_126px)] left-0 top-[126px]">
         <motion.div
          ref={cursorRef}
          className={`relative z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-2/3 uppercase  inline-flex flex-col items-center justify-center font-extrabold text-sm ${isVideoPlaying ? 'hidden' : ''}`}
          variants={variants}
