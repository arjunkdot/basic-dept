          ...
          <Link to="/">
            <figure className="w-40 h-auto">
              <svg
                ...
                className="fill-bs-light dark:fill-bs-pink">
          ...
          <nav className="w-[48%] max-w-[700px] mr-[9rem]">
            <ul className="flex justify-between uppercase text-sm text-bs-light dark:text-bs-pink">
              {headerNavItems.map((item) => (
                <li
                  key={item.id}
                  className="relative after:content-[''] after:absolute after:w-[0%] after:h-[1px] after:right-0 after:bottom-[2px] after:bg-bs-light after:ease-default after:duration-300 hover:after:w-[100%] hover:after:left-0 hover:after:ease-default hover:after:duration-300">
