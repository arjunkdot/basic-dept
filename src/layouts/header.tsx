    ...
    <header className="relative z-10">
      <div className="mx-auto fixed flex justify-between items-center  w-full h-[126px] max-w-[90%]  top-0 left-1/2 translate-x-[-50%]">
        ...
        <button className="group w-10 h-10 rounded-full cursor-pointer">
          <span className="w-[6px] h-[6px] relative inline-block bg-bs-light rounded-full ease-default after:content-[''] after:inline-block after:absolute after:bg-bs-light after:w-[6px] after:h-[6px] after:rounded-full after:left-[9px] after:ease-default after:duration-150 before:content-[''] before:inline-block before:absolute before:bg-bs-light before:w-[6px] before:h-[6px] before:rounded-full before:right-[9px] before:ease-default before:duration-150 group-hover:after:left-[10px] group-hover:before:right-[10px] group-hover:before:ease-default group-hover:before:duration-150 group-hover:after:ease-default group-hover:after:duration-150"></span>
        </button>
      </div>
    </header>
  );
