...
const HeaderMenu = () => {
  ...
  return (
    <div className="bg-bs-dark fixed w-full h-full left-0 top-0 z-50">
      ...
      <Carousel>
        <ul className="w-full flex items-start px-20 overflow-auto">
          {data.allMarkdownRemark.edges.map((edge) => {
            return (
              <li
                key={edge.node.frontmatter?.order}
                className="relative w-[30%] h-[70vh] shrink-0 px-2 group before:content-[''] before:block before:absolute before:top-0 before:left-0 before:h-full before:w-[1px] before:bg-bs-pink">
                <div className="flex flex-col">
                  <div className="relative oveflow-hidden shrink-0 ease-default overflow-hidden duration-300 h-[calc(100vh-44vh)] group-hover:h-[calc(100vh-55vh)] group-hover:ease-default group-hover:duration-300">
                    <svg
