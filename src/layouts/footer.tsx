...
const Footer = () => {
  return (
    <footer className="bg-bs-dark text-bs-light w-full">
      <div className="bs-wrapper py-28">
        <div className="w-full flex align-top justify-between gap-5">
          <div className="w-1/2">
            <figure className="w-[4.25rem] h-[1.375rem]">
              <svg
          ...
          <div className="w-1/2">
            <p className="text-[2rem] leading-8 font-semibold antialiased mr-[6.9rem]">
        ...
        <div className="w-full flex align-top justify-between gap-5 mt-[10.125rem]">
          <div className="w-1/2">
            <form className="mr-28">
              <label
                htmlFor="email"
                className="relative pl-6 uppercase tracking-wide text-lg before:content-['●'] before:absolute before:inline-block before:-left-[.1rem]">
                Stay in the know
              </label>
              <div className="relative mt-1">
                <input
                  ...
                  className="bg-bs-transparent font-scoto font-normal text-lg placeholder:text-bs-light placeholder:opacity-80 outline-none ease-default w-full h-[3.438rem] leading-[3.438rem] duration-150 border-b border-bs-light focus:outline-none focus:border-b-2"
                />
                <button
                  type="submit"
                  aria-label="Submit"
                  ...
                  <figure className="w-[1.125rem] h-[1.125rem]">
                    <svg
          ...
          <div className="w-1/2 flex justify-between pr-[6.9rem]">
            <div>
              <h4 className="relative pl-6 uppercase tracking-wide text-lg before:content-['●'] before:absolute before:inline-block before:-left-[.1rem]">
                Social
              </h4>
              <ul className="mt-4">
                <li className="group text-lg antialiased leading-[1.5rem]">
      ...
      <div className="bg-bs-extradark text-bs-grey w-full py-6 ">
        <div className="bs-wrapper flex align-middle justify-between text-[.688rem] antialiased uppercase">
