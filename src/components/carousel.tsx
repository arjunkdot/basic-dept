  ...
  return (
    <div
      ...
      <motion.div
        ...
        ease-linear duration-150 ${isDown ? 'w-[80px] h-[80px]' : 'w-[8.25vw] h-[8.25vw]'} ${isDown ? '' : 'before:border-opacity-0 before:ease-linear before:duration-150  before:-left-[30px] after:border-opacity-0 after:ease-linear after:duration-150  after:-right-[30px]'} rounded-full`}>
